 ...
 */
class Program extends ResourceManager
{
	constructor()
	{
		super();
	 ...
	 */
	setMouseKeyboard(mouse, keyboard)
	{
		if(this.mouse !== mouse)
		{
			if(this.mouse !== null)
	 ...
	 */
	setRenderer(renderer, configure)
	{
	...
	async clone()
	{
		...
		return await new ObjectLoader().parse(await this.toJSON());
	}
	 ...
	 */
	async receiveDataApp(data)
	{
		const { Script } = await import("./script/Script.js");
