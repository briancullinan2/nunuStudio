...
class EditorSettingsTab extends TabComponent {
	constructor(parent, closeable, container, index) {
		...
		// Default camera distance (z-far)
		// Default camera distance (z-far)
		this.form.addText("Default camera distance (z-far)");
		this.cameraDistanceZFar = new NumberBox(this.form);
	...
	activate() {
		...
		this.cameraDistanceZFar.setValue(Editor.settings.editor.cameraDistanceZFar);
